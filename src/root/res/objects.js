function initObjects() {
	...
	hammer_valley = new L.polygon([
	    [9.557417356841308,-14.721679687500002],
	    [9.622414142924818,-14.051513671875002],
	    [8.135367205502854,-13.612060546875002],
	    [3.7217452310689536,-14.172363281250002],
	    [3.1514858749293237,-14.611816406250002],
	...
	//new L.circle([-55.727110085045986,-92.30712890625001],{radius: 240000})
	npp = new L.polygon([
		[-51.289406,-89.692383],
		[-54.033586,-88.967285],
		[-58.482209,-81.826172],
	...
	bergmann_tunnels = new L.polygon([
	    [2.855262784366583,-14.458007812500002],
	    [3.162455530237848,-13.623046875],
	    [-1.8893059628373186,-12.502441406250002],
	    [-14.859850400601037,-10.898437500000002],
	    [-25.62171595984574,-9.843750000000002],
	    [-41.836827860727134,-9.294433593750002],
	    [-52.789475581398875,-8.283691406250002],
	    [-57.468589192089325,-8.393554687500002],
	    [-64.8115572502203,-14.194335937500002],
	    [-70.18882659254719,-21.588134765625],
	    [-70.02434079930295,-23.071289062500004],
	    [-64.50118574349311,-15.996093750000002],
	    [-59.085738569819505,-11.601562500000002],
	    [-57.25528054528889,-10.173339843750002],
	    [-52.76289173758373,-9.755859375000002],
	    [-38.66835610151506,-11.0302734375],
	...
	//turnip_hill = new L.circle([-65.07213008560697,-73.57543945312501],{radius: 55000})
	turnip_hill = new L.polygon([
		[-66.080457,-71.191406],
		[-65.757706,-72.04834],
		[-65.229102,-72.13623],
		[-64.415921,-72.004395],
	...
	pitheath_canal = new L.polygon([
	    [-61.4964919175874,-7.998046875000001],
	    [-61.40197804859897,-7.503662109375001],
	    [-63.203925767041305,-7.569580078125001],
	    [-63.19897252647351,-8.228759765625002],
	...
	_office         = alcista_building;
	_reserve1       = hammer_valley;
	_reserve2       = hv_dam;
	_reserve3       = bergmann_tunnels;
	_tunnel1        = bergmann_tunnels;
	_tunnel2        = pinefell_water;
	_tunnel3        = bergmann_tunnels;
	_tunnel4        = bergmann_tunnels;
	_furnace        = stalburg_steel;
	_tower          = stalburg_steel;
	_watertreatment = pitheath_water;
	_sewer          = pitheath_canal;
	_sewer2         = pitheath_canal;
	_sewer3         = pitheath_canal;
	_metro          = pitheath_metro;
	_metroride      = pitheath_metro;
	_waterplant     = central_waterplant;
	_minitrain      = central_metro;
	_central        = central_metro;
	_servicetunnel  = snw_bunker;
	_skyscraper     = walter_tower;
	_bunker         = snw_bunker;
	_stormdrain     = west_runoff_system;
	_cistern        = west_runoff_system;
	_powerstation2  = powerstation;
	_isle1          = castlerock_island;
	_isle2          = castlerock_island;
	_isle3          = castlerock_island;
	_business       = point_elias;
	_business2      = point_elias;
	_officeblackout = alcista_building;
	_rails          = turnip_hill;
	_tenements      = turnip_hill;
	_river          = villa;
	_field          = npp;
	_reactor        = npp;
	_roof           = npp;
	_ending_1       = turnip_hill;
	_ending_2       = mark_house;
	_hallway        = bergmann_tunnels;
	_city_gates     = opensewer;
