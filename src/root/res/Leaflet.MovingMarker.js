...
L.Marker.MovingMarker = L.Marker.extend({
    ...
    _createDurations: function (latlngs, duration) {
        ...
        for (i = 0; i < distances.length; i++) {
            durations.push(distances[i] / speed);
            //console.log(distances[i] + ' - ' + distances[i] / speed)
            //if (duration/lastIndex < 300) {
            //    durations.push(300);
            //} else {
            //    durations.push(duration/lastIndex);
            //}
        }
